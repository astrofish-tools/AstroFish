...
public class BaseActivity extends Activity implements DisplayManager.Listener {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        switch (event.getScanCode()) {
            ...
            case ScalarInput.ISV_KEY_DISP:
                return onDisplayKeyDown();
    ...
    protected boolean onDisplayKeyDown() { return false; }
    protected boolean onDisplayKeyUp() { return false; }
